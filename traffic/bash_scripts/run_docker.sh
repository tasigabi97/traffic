echo 1.15.2 working
echo 1.12.0 not working
sudo docker run --runtime=nvidia --gpus all      -t -it --rm --ipc=host -v "/home/gabi/PycharmProjects/traffic/:/traffic" tensorflow/tensorflow:1.12.0-gpu-py3 python /traffic/traffic/examples/tensorflow_1.py
echo 1.12.0 working
